...
var startwrite = func() {
    ...
    output_file = getprop("/sim/fg-home") ~ "/Export/tacview-A10A-" ~ filetimestamp ~ ".acmi";
    # create the file
...
var mainloop = func() {
    ...
    foreach (var cx; radar_system.getCompleteList()) {
        if(cx.getType() == radar_system.ORDNANCE) {
            continue;
        }
...
var getIas = func() {
    return rounder(getprop("/velocities/airspeed-kt") * KT2MPS,1.0);
}
